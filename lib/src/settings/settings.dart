...
class SettingsController {
  ...
  ValueNotifier<bool> specialModeOn = ValueNotifier(false);
  ...
  Future<void> loadStateFromPersistence() async {
    await Future.wait([
      ...
      _persistence
          .getSpecialModeOn()
          .then((value) => specialModeOn.value = value),
    ]);
  }
  ...
  void toggleSpecialMode() {
    specialModeOn.value = !specialModeOn.value;
    _persistence.saveSpecialModeOn(specialModeOn.value);
  }
}
